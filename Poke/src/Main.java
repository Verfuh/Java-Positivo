...
public class Main {
    public static void main(String[] args) {
        ...
        pokemon zard = new pokemon("Charizard", 200, 60, Arrays.asList(hyperBeam, flamethrower, aerialAce, dragonClaw));
        pokemon toise = new pokemon("Blastoise", 230, 60, Arrays.asList(tackle, waterGun, crunch, blizzard));
