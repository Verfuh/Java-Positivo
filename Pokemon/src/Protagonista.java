...
public class Protagonista extends Pokedex implements Serializable {
    ...
    void listaMoves(int atual){
        ...
        System.out.println("\n|\u001B[107m \u001B[30m" + pokemons.get(atual).getMoveName(2) + "PP: " + pokemons.get(atual).getMovePP(2) + "/" + pokemons.get(atual).getMoveMaxPP(2) + "      " + pokemons.get(atual).getMoveName(3) + " PP: " + pokemons.get(atual).getMovePP(3) + "/" + pokemons.get(atual).getMoveMaxPP(3) + "\u001B[0m|");
    }
